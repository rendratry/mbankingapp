...
import 'package:mbanking_app/src/pages/ver_pin_page.dart';
...
class CreatePinPage extends StatefulWidget {
  ...
  static Route route() {
    return MaterialPageRoute<void>(builder: (_) => const CreatePinPage());
  }
}
...
class _CreatePinPageState extends State<CreatePinPage> {
  ...
  validatePin() {
    ...
    if (pin.length == 6) {
      Navigator.pushReplacement(context, VerPinPage.route());
    }
    clearAllPin();
  }
  ...
  buildSecurityText() {
    return const Text(
      "Buat pin untuk melakukan setiap transaksi di\naplikasi pastikan kamu mengingatnya",
